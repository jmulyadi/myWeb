...
export function PPNavbar() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <div class="relative bottom-0 bg-amber-500 h-[2px] w-0 group-hover:w-full transition-all duration-500"></div>
      </Link>
      <Link
        className="group cursor-pointer"
        smooth
  ...
  return (
    <Navbar className="sticky top-0 z-10 mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        <Link
          className="group cursor-pointer transform transition-transform duration-300 hover:scale-110"
          smooth
          to="/"
        >
          <Typography
        ...
        <div className="flex items-center gap-x-1">
          <Link className="group cursor-pointer" smooth to="/#contact">
        ...
        <div className="container mx-auto">
          ...
          <div className="flex items-center gap-x-1">
            <div className="flex-1">
              <Link className="group cursor-pointer" to="/#contact">
